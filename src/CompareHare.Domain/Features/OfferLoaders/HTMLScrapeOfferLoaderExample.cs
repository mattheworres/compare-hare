// This was the original PA Power loader I wrote in 2018-19, the PA PUC
// hadn't shown a consumable JSON resource, but when I checked Jan 2021
// they had actually changed the HTML source below (which I have an HTML
// copy of for the unit test).

// Still, this will prove to be an excellent example for myself on how
// to use the AngleSharp library, which is a Jquery-like C# library
// for traversing and consuming HTML content.
