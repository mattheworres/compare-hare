...
namespace CompareHare.Domain.Features.PriceScrapers.Interfaces
{
    public interface IPriceScraper : IFeatureService
    {
        ...
        Task<ProductRetailerPrice> ScrapePrice(int trackedProductId, int trackedProductRetailerId, ProductRetailer productRetailer, string productIdentifier1, string productIdentifier2, IRequester requester = null);
    }
}
